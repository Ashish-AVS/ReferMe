    ...
    <div>
      <div className="bg-white py-6 sm:py-8 lg:py-12">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <h2 className="mb-4 text-center text-4xl font-bold text-gray-800 md:mb-8 lg:text-3xl xl:mb-12">
            Our community
            <br />
            loves using <span className="text-violet-400">GetReferred</span>
          </h2>
